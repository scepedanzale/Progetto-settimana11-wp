...
if($adventure_travelling_tp_color_option != false){
$adventure_travelling_tp_theme_css .='#slider .inner_carousel, #static-blog h3  {';
...
if($adventure_travelling_tp_color_option_link != false){
$adventure_travelling_tp_theme_css .='a:hover, #theme-sidebar a:hover,.media-links i:hover , #footer a:hover , p.wp-block-tag-cloud a :hover, .page-box h4 a:hover,.page-box h4 a:hover, .readmore-btn a:hover, .logo h1 a:hover,#theme-sidebar  .product-name a:hover, woocommerce-checkout-review-order:hover ,.woocommerce-form-coupon-toggle a:hover, .woocommerce-MyAccount-content a:hover, .box-content a:hover, .woocommerce-privacy-policy-text a:hover,.post_tag a:hover,#theme-sidebar .tagcloud a:hover, p.wp-block-tag-cloud a:hover, #theme-sidebar .widget_tag_cloud a:hover{';
$adventure_travelling_tp_theme_css .='color: '.esc_attr($adventure_travelling_tp_color_option_link).';';
$adventure_travelling_tp_theme_css .='}';
}
if($adventure_travelling_tp_color_option_link != false){
$adventure_travelling_tp_theme_css .='#footer .tagcloud a:hover,#footer a:hover,#theme-sidebar a:hover,#theme-sidebar .tagcloud a:hover,#theme-sidebar .tagcloud a:hover, p.wp-block-tag-cloud a:hover, .read-more-btn a :hover,.post_tag a:hover, #theme-sidebar .widget_tag_cloud a:hover, .readmore-btn a:hover{';
